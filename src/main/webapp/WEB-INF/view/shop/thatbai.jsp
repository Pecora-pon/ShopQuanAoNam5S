...
<div class="container mt-4">
    <div class="container mt-5">
        <div class="alert alert-danger" role="alert">
            <h4 class="alert-danger">Thất bại!</h4>
            <p>Cảm ơn bạn đã sử dụng trang web của chúng tôi. Thông báo thất bại.</p>
            <hr>
            <p>Bạn có thể quay lại giỏ hàng để tiếp tục thanh toán hoặc quay lại trang chủ để tiếp tục mua hàng</p>
            <hr>
