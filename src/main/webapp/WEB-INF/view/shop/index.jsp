    ...
    <section class="banner spad">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 p-0">
                    <div class="testimonial__pic set-bg" data-setbg="../mainshop/mainshop2/img/about/testimonial-pic.jpg" style="background-image: url(&quot;../mainshop/mainshop2/img/about/testimonial-pic.jpg&quot;);"></div>
                </div>
<%--                <div class="col-lg-7 offset-lg-4">--%>
<%--                    <div class="banner__item">--%>
<%--                        <div class="banner__item__pic">--%>
<%--                            <img src="../mainshop/mainshop2/img/banner/banner.jpg" alt="">--%>
<%--                        </div>--%>
