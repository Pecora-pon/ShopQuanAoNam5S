                            ...
                            <form:form action="/don-hang/update/${donHangID}" modelAttribute="dh" method="POST" onsubmit="return validateFormDH()">
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <form:input class="form-control" path="donHangID" disabled="true" value="${dh.donHangID}"/>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <form:input class="form-control" path="tenKhach" value="${dh.tenKhach}"/>
                                        <form:errors path="tenKhach"/>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">Số Điện Thoại</label>
                                        <form:input class="form-control" path="soDienThoai" value="${dh.soDienThoai}"/>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <form:input class="form-control" path="hinhThucThanhToan" value="${dh.hinhThucThanhToan}"/>
                                        <form:errors path="hinhThucThanhToan"/>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">Ngày Đặt Hàng</label>
                                        <form:input type="date" class="form-control" path="ngayDatHang" value="${dh.ngayDatHang}"/>
