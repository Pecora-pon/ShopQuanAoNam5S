        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form:form action="/danh-sach-yt/add" modelAttribute="yt" method="POST">
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">ID Khách Hàng</label>
                                        <form:input class="form-control" path="danhSachYeuThichID" disabled="true" value="${yt.danhSachYeuThichID}"/>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <form:select path="khachHang">
                                            <c:forEach items="${listkh}" var="cv">
                                                <option value="${cv.khachHangId}" ${cv.khachHangId==kh.khachHang.khachHangId?"selected":""}>${cv.hoTen}</option>
                                            </c:forEach>
                                        </form:select>
                                    </div>
                                </div>
...
<%--                                                <a class="dropdown-item" href="/danh-sach-yt/view-update/${kh.danhSachYeuThichID}"><i class="bx bx-edit-alt me-1"></i> Sửa</a>--%>
                                                <a class="dropdown-item" href="/danh-sach-yt/delete/${kh.danhSachYeuThichID}"><i class="bx bx-trash me-1"></i> Xóa</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                            ...
                            <ul class="pagination">
                                <c:forEach begin="0" end="${totalPages}" var="page">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <li class="page-item"><a class="page-link" href="/danh-sach-yt/page?page=${page}">${page}</a></li>
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
                            </ul>
