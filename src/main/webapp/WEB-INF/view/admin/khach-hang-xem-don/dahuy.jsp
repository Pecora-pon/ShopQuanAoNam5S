...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                <form action="/timkiemtendh" method="get" class="d-flex align-items-center">
            ...
            <div class="col-md-4 mb-3">
                <form action="/timkiemtongtiendh" method="get" class="d-flex align-items-center">
                ...
                <ul class="pagination">
                    <c:forEach begin="0" end="${totalPages}" var="page">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <li class="page-item"><a class="page-link" href="/khach-hang-xem/page4?page=${page}">${page}</a></li>
                            </c:otherwise>
                        </c:choose>
                    </c:forEach>
                </ul>
