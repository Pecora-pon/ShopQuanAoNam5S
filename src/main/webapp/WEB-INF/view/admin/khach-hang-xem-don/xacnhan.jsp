    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                <form action="/timkiemngayxn" method="get" class="d-flex align-items-center">
            ...
            <div class="col-md-4 mb-3">
                <form action="/timkiemtenxn" method="get" class="d-flex align-items-center">
            ...
            <div class="col-md-4 mb-3">
                <form action="/timkiemtongtienxn" method="get" class="d-flex align-items-center">
