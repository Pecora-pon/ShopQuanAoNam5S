                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form:form action="/nhan-vien-add" modelAttribute="nv" method="POST" onsubmit="return validateForm()">
...
<%--It looks like you want to integrate form validation logic into the existing form using Spring MVC (based on the <form:form> tags). Here's how you can modify the provided JavaScript code to validate the form fields in a way that aligns with your Spring MVC form:--%>
...
<script>
    function validateForm() {
        ...
        if (hoTen === "" || diaChi === "" || soDienThoai === "" || tenDangNhap === "" || email === "" || matKhau === "") {
