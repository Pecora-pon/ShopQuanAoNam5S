...
<<<<<<< HEAD:src/main/webapp/WEB-INF/view/admin/nhanvien-update.jsp
    <title>Nhân viên</title>
=======
    <title>Chức vụ</title>
>>>>>>> 32f04127f71ac1add5b83ad6c6963e7181614f86:src/main/webapp/WEB-INF/view/admin/khach-hang/view-update.jsp
...
<<<<<<< HEAD:src/main/webapp/WEB-INF/view/admin/nhanvien-update.jsp
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form:form action="/nhan-vien/update/${nv.nhanVienID}" modelAttribute="nv" method="POST">
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">ID nhân viên</label>
                                        <form:input class="form-control" path="nhanVienID" disabled="true" value="${nv.nhanVienID}"/>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="/nhan-vien-view-update/${nhanvien.nhanVienID}"><i
                                                        class="bx bx-edit-alt me-1"></i> Sửa</a>
                                                <a class="dropdown-item" href="/nhan-vien/delete/${nhanvien.nhanVienID}"><i
