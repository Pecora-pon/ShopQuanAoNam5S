                        ...
                        <table class="table">
                            ...
                            <c:forEach items="${list}" var="dhct" varStatus="i">
                                <tr>
                                    ...
                                    <td>
                                        <c:if test="${dhct.trangThai == 5}"> Xác Nhận </c:if>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" href="/chuyenttt/${dhct.donHang.donHangID}"><i
                            ...
                            <ul class="pagination">
                                <c:forEach begin="0" end="${totalPages}" var="page">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <li class="page-item"><a class="page-link" href="/don-hang-chi-tiet/page5?page=${page}">${page}</a></li>
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
                            </ul>
