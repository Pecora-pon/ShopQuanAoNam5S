        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <!-- Table add -->
                    <div class="card">
                        <h3 class="card-header">Quản lý hóa đơn</h3>
                        <div class="card-body">
                            <form:form action="/don-hang-chi-tiet/update/${donHangChiTietID}" modelAttribute="dhct"
                                       method="POST">
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <form:select path="giamGia">
                                        <c:forEach items="${listGG}" var="gg">
                                            <option value="${gg.giamGiaID}" ${gg.giamGiaID==dhct.giamGia.giamGiaID?"selected":""}>${gg.giamGiaID}</option>
                                        </c:forEach>
                                    </form:select>
                                </div>
                                <div class="mb-3 col-md-6">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select name="trangThai" class="form-select" aria-label="Default select example">
                                        ...
                                        <option value="0" ${dhct.trangThai==0?"selected":""}>Chưa thanh toán</option>
                                ...
                                <div class="mt-2">
                                    <button type="submit" id="myButton" class="btn btn-primary me-2"> Sửa</button>
                            ...
                            <table class="table">
                                ...
                                <c:forEach items="${list}" var="dhct" varStatus="i">
                                    <tr>
                                        ...
                                        <td>${dhct.giamGia.maGiamGia}</td>
                                        <td>${dhct.soLuong}</td>
                                        <td>
                                            <c:if test="${dhct.trangThai == 0}"> Chưa thanh toán </c:if>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                        <%--                                                <a class="dropdown-item" href="/don-hang-chi-tiet/view-update/${dhct.donHangChiTietID}"><i--%>
