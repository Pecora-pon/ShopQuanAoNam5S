    ...
    <div class="layout-container">
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
              ...
              <div class="card">
                  <div class="card-body">
                      <form:form action="/chuc-vu-add" modelAttribute="cv" method="POST">
                    <div class="row">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="/chuc-vu-view-update/${chucvu.chucVuID}"><i class="bx bx-edit-alt me-1"></i> Sửa</a>
