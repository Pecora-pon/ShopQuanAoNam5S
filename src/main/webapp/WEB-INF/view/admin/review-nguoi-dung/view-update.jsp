        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form:form action="/review/update/${reviewID}" modelAttribute="rv" method="POST">
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">ID Review</label>
                                        <form:input class="form-control" path="reviewID" disabled="true" value="${rv.reviewID}"/>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <form:select path="khachHang">
                                            <c:forEach items="${listkh}" var="cv">
                                                <option value="${cv.khachHangId}" ${cv.khachHangId==rv.khachHang.khachHangId?"selected":""}>${cv.hoTen}</option>
                                            </c:forEach>
                                        </form:select>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <form:select path="sanPham">
                                            <c:forEach items="${listsp}" var="sp">
                                                <option value="${sp.sanPhamID}" ${sp.sanPhamID==rv.sanPham.sanPhamID?"selected":""}>${sp.tenSanPham}</option>
                                            </c:forEach>
                                        </form:select>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">Bình Luận</label>
                                        <form:input class="form-control" path="binhLuan" value="${rv.binhLuan}"/>
                                    </div>
                                </div>
                                <div class="mt-2">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="/review/view-update/${v.reviewID}"><i class="bx bx-edit-alt me-1"></i> Sửa</a>
                                                <a class="dropdown-item" href="/review/delete/${v.reviewID}"><i class="bx bx-trash me-1"></i> Xóa</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                            ...
                            <ul class="pagination">
                                <c:forEach begin="0" end="${totalPages}" var="page">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <li class="page-item"><a class="page-link" href="/review/hien-thi/page?page=${page}">${page}</a></li>
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
                            </ul>
