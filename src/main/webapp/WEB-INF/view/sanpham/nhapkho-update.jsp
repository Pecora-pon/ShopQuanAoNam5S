            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form:form action="/nhap-kho/update/${nk.nhaKhoID}" modelAttribute="nk" method="POST">
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">ID nhà kho</label>
                                        <form:input class="form-control" path="nhapKhoID" disabled="true"
                                                    value="${nk.nhapKhoID}"/>
                                    </div>
                                    <div class="mb-3 col-md-6">
                    ...
                    <div class="card">
                        ...
                        <table class="table">
                            ...
                            <c:forEach items="${listNhapKho}" var="nhapkho">
                                <tr>
                                    <td>${nhapkho.nhapKhoId}</td>
                                    <td>${nhapkho.mauSac.tenMauSac}</td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                   href="/nhap-kho-view-update/${nhapkho.nhapKhoID}"><i
                                                        class="bx bx-edit-alt me-1"></i> Sửa</a>
                                                <a class="dropdown-item"
                                                   href="/nhap-kho/delete/${nhapkho.nhapKhoID}"><i
