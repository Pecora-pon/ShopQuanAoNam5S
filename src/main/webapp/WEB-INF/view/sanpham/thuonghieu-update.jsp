...
<head>
    ...
    <title>Thương hiệu - Update</title>
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <!--Table add -->
                    <div class="card">
                        <h3 class="card-header">Quản lý Thương Hiệu</h3>
                        <div class="card-body">
                            <form:form action="/thuong-hieu/update/${th.thuongHieuID}" modelAttribute="th" method="POST">
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">ID Thuong Hiệu</label>
                                        <form:input class="form-control" path="thuongHieuID" disabled="true" value="${th.thuongHieuID}"/>

                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">Tên Thương hieu</label>
                                        <form:input class="form-control" path="tenThuongHieu" value="${th.tenThuongHieu}"/>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="/thuong-hieu-view-update/${thuonghieu.thuongHieuID}"><i class="bx bx-edit-alt me-1"></i> Sửa</a>
                                                <a class="dropdown-item" href="/thuong-hieu/delete/${thuonghieu.thuongHieuID}"><i class="bx bx-trash me-1"></i> Xóa</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                            ...
                            <ul class="pagination">
                                <c:forEach begin="0" end="${totalPages}" var="page">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <li class="page-item"><a class="page-link" href="/thuong-hieu/page?page=${page}">${page}</a></li>
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
                            </ul>
