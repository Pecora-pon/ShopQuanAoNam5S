        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <!-- Table add -->
                    <div class="card">
                        <h3 class="card-header">Quản lý size</h3>
                        <div class="card-body">
                            <form:form action="/size/update/${si.sizeID}" modelAttribute="si" method="POST">
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">ID size</label>
                                        <form:input class="form-control" path="sizeID" disabled="true"
                                                    value="${si.sizeID}"/>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                   href="/size-view-update/${size.sizeID}"><i
                                                        class="bx bx-edit-alt me-1"></i> Sửa</a>
                                                <a class="dropdown-item"
                                                   href="/size/delete/${size.sizeID}"><i
                            ...
                            <ul class="pagination">
                                <c:forEach begin="0" end="${totalPages}" var="page">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <li class="page-item"><a class="page-link" href="/size/page?page=${page}">${page}</a></li>
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
                            </ul>
