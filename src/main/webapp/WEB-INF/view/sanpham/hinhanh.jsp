        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <!-- Table add -->
                    <div class="card">
                        <h3 class="card-header">Quản lý hình ảnh</h3>
                        <div class="card-body">
                            <form:form action="/hinh-anh-add" modelAttribute="ha" method="POST">
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">ID hình ảnh</label>
                                        <form:input class="form-control" path="hinhAnhID" disabled="true"
                                                    value="${ha.hinhAnhID}"/>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">Tên URL</label>
                                        <form:input class="form-control" path="hinhAnhURL" value="${ha.hinhAnhURL}"/>
                                        <form:errors path="hinhAnhURl"/>
                                    </div>
                    ...
                    <div class="card">
                        ...
                        <table class="table">
                            ...
                            <c:forEach items="${listHinhAnh}" var="hinhanh">
                                <tr>
                                    <td>${hinhanh.hinhAnhID}</td>
                                    <td>${hinhanh.hinhAnhURL}</td>
                                        <%--                                    <td>--%>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                   href="/hinh-anh-view-update/${hinhanh.hinhAnhID}"><i
                                                        class="bx bx-edit-alt me-1"></i> Sửa</a>
                                                <a class="dropdown-item"
                                                   href="/hinh-anh/delete/${hinhanh.hinhAnhID}"><i
                            ...
                            <ul class="pagination">
                                <c:forEach begin="0" end="${totalPages}" var="page">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <li class="page-item"><a class="page-link" href="/mau-sac/page?page=${page}">${page}</a></li>
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
                            </ul>
