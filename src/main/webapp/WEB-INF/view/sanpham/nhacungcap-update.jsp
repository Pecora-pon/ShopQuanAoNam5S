        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <!-- Table add -->
                    <div class="card">
                        <h3 class="card-header">Quản lý nhà cung cấp</h3>
                        <div class="card-body">
                            <form:form action="/nha-cung-cap/update/${ncc.nhaCungCapID}" modelAttribute="ncc" method="POST">
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">ID nhà cung cấp</label>
                                        <form:input class="form-control" path="nhaCungCapID" disabled="true"
                                                    value="${ncc.nhaCungCapID}"/>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">Tên nhà cung cấp</label>
                                        <form:input class="form-control" path="tenNhaCungCap" value="${ncc.tenNhaCungCap}"/>
                                        <form:errors path="tenNhaCungCap"/>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">Địa chỉ</label>
                                        <form:input class="form-control" path="diaChi" value="${ncc.diaChi}"/>
                                        <form:errors path="diaChi"/>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">Sdt</label>
                                        <form:input class="form-control" path="sdt" value="${ncc.sdt}"/>

                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">Email</label>
                                        <form:input class="form-control" path="email" value="${ncc.email}"/>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                   href="/nha-cung-cap-view-update/${nhacungcap.nhaCungCapID}"><i
                                                        class="bx bx-edit-alt me-1"></i> Sửa</a>
                                                <a class="dropdown-item"
                                                   href="/nha-cung-cap/delete/${nhacungcap.nhaCungCapID}"><i
                            ...
                            <ul class="pagination">
                                <c:forEach begin="0" end="${totalPages}" var="page">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <li class="page-item"><a class="page-link" href="/nha-cung-cap/page?page=${page}">${page}</a></li>
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
                            </ul>
