            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form:form action="/chat-lieu/update/${cl.chatLieuID}" modelAttribute="cl" method="POST">
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">ID màu sắc</label>
                                        <form:input class="form-control" path="chatLieuID" disabled="true"
                                                    value="${cl.chatLieuID}"/>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                   href="/chat-lieu-view-update/${chatlieu.chatLieuID}"><i
                                                        class="bx bx-edit-alt me-1"></i> Sửa</a>
                                                <a class="dropdown-item"
                                                   href="/chat-lieu/delete/${chatlieu.chatLieuID}"><i
                            ...
                            <ul class="pagination">
                                <c:forEach begin="0" end="${totalPages}" var="page">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <li class="page-item"><a class="page-link" href="/chat-lieu/page?page=${page}">${page}</a></li>
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
                            </ul>
