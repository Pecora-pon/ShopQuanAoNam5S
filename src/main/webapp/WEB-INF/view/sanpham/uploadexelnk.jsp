            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <span class="app-brand-logo demo">
                    ...
                    <!-- /Logo -->
                    <h4 class="mb-2">Uploadxel</h4>

                    <form:form id="formAuthentication" class="mb-3" action="/uploadexelnk" enctype="multipart/form-data"  modelAttribute="nk" method="POST">
                        ...
                        <div class="border border-secondary rounded p-3">
                            <div>
                                <div class="mb-3 col-md-6">
                                    <label class="form-label">Uploadexel</label>
                                    <input type="file"  name="fileLoactionnk" class="form-control-file"/>
                    ...
                    <div class="text-center">
                        <a href="/nhap-kho" class="d-flex align-items-center justify-content-center">
                            <i class="bx bx-chevron-left scaleX-n1-rtl bx-sm"></i>
                            Back
                        </a>
