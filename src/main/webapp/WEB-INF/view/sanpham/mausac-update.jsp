            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form:form action="/mau-sac/update/${ms.mauSacID}" modelAttribute="ms" method="POST">
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">ID màu sắc</label>
                                        <form:input class="form-control" path="mauSacID" disabled="true"
                                                    value="${ms.mauSacID}"/>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                   href="/mau-sac-view-update/${mausac.mauSacID}"><i
                                                        class="bx bx-edit-alt me-1"></i> Sửa</a>
                                                <a class="dropdown-item"
                                                   href="/mau-sac/delete/${mausac.mauSacID}"><i
